...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.input_path.setText(_translate("MainWindow", "/data2/results/evaluation/reconstruction_model_09.mrc"))
        self.model_pathL.setText(_translate("MainWindow", "Model Path"))
        self.model_path.setText(_translate("MainWindow", "/data2/results/evaluation/model_final_weights_categorical_50_alldata_56_DET.h5"))
        self.output_pathL.setText(_translate("MainWindow", "Output Path"))
        self.output_path.setText(_translate("MainWindow", "/data2/results/evaluation/"))
