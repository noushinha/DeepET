...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        # self.model_path.setText(_translate("MainWindow", "/data2/results/RealData/evaluation/model_weights_3DUNet_RB_13.h5"))
        # self.model_path.setText(_translate("MainWindow", "/data2/results/RealData/evaluation/epoch=161-val_dice=0.8099.ckpt"))
        # self.model_path.setText(_translate("MainWindow", "/data2/results/RealData/evaluation/checkpoints/checkpoints_ucaps/epoch=86-val_dice=0.6753.ckpt"))
        self.model_path.setText(_translate("MainWindow", "/data2/results/RealData/evaluation/checkpoints/checkpoints_ucaps/epoch=266-val_dice=0.7378.ckpt"))
